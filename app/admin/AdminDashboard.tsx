...
export default function AdminDashboard({ email, name }: { email: string; name: string }) {
  ...
  useEffect(() => {
    ...
    fetch("/api/inquiries", { cache: "no-store" })
      ...
      .catch(() => setNotice("Inquiries could not be loaded. Refresh and try again."))
