...
const faq = [
  ...
  ["What is a typical turnaround?", "Most single-content projects are delivered within 3–5 business days once the brief and product arrive in Rajshahi. Timelines are confirmed before booking."],
    ...
    <main id="content">
      ...
      <header className="nav-wrap">
        <nav className="nav" aria-label="Main navigation">
          <a href="#top" className="wordmark" aria-label="Shadia Noor Mou home">SHADIA<span>CREATES</span></a>
      ...
      <section className="hero" id="top">
        <div className="hero-copy reveal">
          ...
          <div className="hero-proof"><p><strong>Rajshahi, Bangladesh.</strong><br />Available for selected collaborations worldwide.</p></div>
        </div>
      ...
      <section className="stats-section section-pad" aria-label="Studio principles"><div className="stat-grid"><div><strong>Native</strong><p>social-first storytelling</p></div><div><strong>Intentional</strong><p>creative direction, always</p></div><div><strong>Polished</strong><p>edit-ready delivery</p></div><div><strong>BD<span>↗</span></strong><p>Rajshahi · worldwide</p></div></div></section>
