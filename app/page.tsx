...
export default function Home() {
  ...
  return (
    <main id="content">
      ...
      <section className="results section-pad" id="results"><div className="results-header"><p className="eyebrow">Proof, not promises</p><h2>Pretty is just the<br /><em>beginning.</em></h2><p>Every case study shows how Shadia turns a product detail into an easy-to-watch story with a clear commercial purpose.</p></div><div className="case-study"><div className="case-visual"><span className="sample-label">CLIENT CASE STUDY</span><div className="chart"><i /><i /><i /><i /><i /><i /><i /><i /></div><p>Story-led product demo<br /><b>Scroll-stopping</b> creative direction</p></div><div className="case-copy"><span className="case-tag">Skincare · Product demo</span><h3>From ingredient list to a reason to care.</h3><p><b>The brief</b> — Translate product texture and active ingredients into a moment viewers could picture in their own routine.</p><p><b>The direction</b> — A close, tactile routine with a natural voiceover and an opening hook grounded in a familiar skincare frustration.</p><div className="case-tags"><span>Hook development</span><span>Voiceover</span><span>9:16 edit</span></div><a className="text-link" href="#contact">Discuss a case study <Arrow diagonal /></a></div></div></section>
